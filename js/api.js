...
function testStream() {
//     await fetch(base_url + "competitions/2021/matches?status=SCHEDULED", options)
//    .then(response => {
//        return response;
//    })
//    .then(json => {
...
//            </ul>
//            `;
//            document.getElementById('ligainggris').innerHTML = dataz;
//        })
//    })
const streamerr = e => {
...
.then((exampleStream) => {
	...
	reader.read().then(read = (result) => {
		if (result.done) {
            ...
            var cardTeam = "";
            result.value.matches.forEach((team, index) => {
                cardTeam += `
                <style>
            .league {
                padding-top: 15px;
            ...
            `;
                document.getElementById('cek').innerHTML = cardTeam;
            })
      ...
      <style>
            ...
            <div class="card">
                    <div class="card-content center">
                       ...
                       <p>${team.utcDate}</p>
                       <hr/>
                       <p class="league">${val.competition.name}</p>
                    </div>
            </div>
            </div>
      
      `;
      div.innerHTML = cardTeam;
      document.getElementById('ligainggris').append(div);
  })
}
...
// render = val => {
//         console.log(val);
//         const scheduleLeague = document.createElement('div');
//         val.matches.forEach(team => {
//         scheduleLeague.innerHTML = `
//         <style>
//         .league {
//             padding-top: 15px;
//             font-weight: 500;
...
//         </div>
//         `;
//         document.getElementById('ligainggris').appendChild(scheduleLeague);
//     })
// }
}